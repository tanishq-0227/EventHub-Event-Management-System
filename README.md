# 🎟️ EventHub — Event Management & Ticket Booking System
...
**Developed by [Tanishq Vashishtha](https://github.com/Tanishq-0227)**
...
```bash
git clone https://github.com/Tanishq-0227/EventHub-Event-Management-System.git
...
│   ├── config/                 # DB connection, Cloudinary, Redis
...
| Name | Roll No. | GitHub |
|------|----------|--------|
| Tanishq Vashishtha | 2315002286 | [@Tanishq-0227](https://github.com/Tanishq-0227) |
